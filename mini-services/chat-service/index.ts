  ...
  socket.on('send-message', (data: {
    ...
    const message = {
      ...
      sender: {
        ...
        avatar_url: data.senderAvatarUrl || null,
        role: data.senderRole || null,
        title_id: data.senderTitleId || null,
        gender: data.senderGender || null,
      },
    };
    ...
    // This ensures delivery even if the recipient hasn't joined the room
